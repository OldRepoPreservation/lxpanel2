 ...
 * Copyright (C) 2006 - 2012 Hong Jen Yee (PCMan) pcman.tw(AT)gmail.com
 *
...
static void on_entry_changed(GtkEntry* entry, GtkImage* img)
{
    ...
    {
        int w, h;
        GIcon* icon = g_themed_icon_new(menu_cache_item_get_icon(MENU_CACHE_ITEM(app)));
...
void lxpanel_show_run_dialog()
{
    ...
    if(!win)
    {
		...
		gtk_box_pack_start((GtkBox*)gtk_dialog_get_content_area((GtkDialog*)win),
